...
<body>
    ...
    <div class="ctn">
        ...
        <div id="etapes" style="display: none">
            ...
            <button id="bouton_valider" class="inactive">Appli 1</button>
            <button id="bouton_valider" class="inactive">Appli 2</button>
        ...
        <div id="home">
             ...
             <h1 id="">Choisir un service</h1>

<div class="home-link">
<h3 id="welcome2">Rendre le véhicule de location au niveau de carburant demandé</h3>
              <a href="RVL"><button>GO</button></a><br><br><br>

              <h3 id="welcome2">Planifier un trajet selon le niveau de carburant actuel</h3>
             <a href="PTC"><button>GO</button></a><br><br><br>
</div>
